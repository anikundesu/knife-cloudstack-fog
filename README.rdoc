...
This is the unofficial Opscode Knife plugin for Apache CloudStack / Accelerite CloudPlatform Clouds. This plugin gives knife the ability to create, bootstrap, and manage instances in Cloudstack Compute clouds.
...
Also, all of these commands have been tested against CloudStack/CloudPlatform 2.2.14, 3.0.6 , 4.3.0.3, and 4.5.1.
...
Copyright:: Copyright (c) 2011 Clogeny, 2012 Datapipe, 2012-2016 IDC Frontier Inc.
