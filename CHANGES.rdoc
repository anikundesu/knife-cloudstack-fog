...
* Added support for SSH gateways based on the code from knife-ec2. This code does not support using SSH config files and 
  needs to have the gateway host connection information specified as a part of the knife command itself.
